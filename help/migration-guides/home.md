...
# Ajuda de migração e conversão do Primetime

Bem-vindo à ajuda de Migração e Conversão do Adobe Primetime. Os documentos listados na navegação à esquerda explicam o processo de conversão e migração para mover do Primetime TVSDK Suite existente para a próxima geração.
