...
## Aprimoramentos e correções nas notas de versão do TVSDK 3.10 iOS

O lançamento focou na solução de problemas principais do cliente e na atualização do certificado de transporte de individualização.
