---
description: Você pode usar a API do Player do Primetime para personalizar o comportamento do reprodutor. Essas classes descrevem o player de mídia e seus recursos.
...
Você pode usar a API do Player do Primetime para personalizar o comportamento do reprodutor. Essas classes descrevem o player de mídia e seus recursos.

Para ver a documentação completa da API do TVSDK, acesse [Adobe Primetime API references](https://help.adobe.com/en_US/primetime/api/index.html).
...
<table frame="all" colsep="1" rowsep="1" id="table_2801E01282A948E6917910CA2FD1E05C"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe que define todas as propriedades de estilo para o texto em legendas ocultas. </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/ClosedCaptionsVisibility.html" format="html" scope="external"> VisibilidadeLegendasocultas</a></span> </td> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe base de fábrica para criar e gerenciar vários componentes usados no fluxo de trabalho de publicidade. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">Implementação padrão da fábrica <span class="codeph"> MediaPlayerClient</span> que fornece suporte para Metadados e processo de resolução de anúncios. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe de configuração para a implementação padrão do reprodutor de mídia. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe de configuração de item do reprodutor de mídia padrão. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe que fornece contexto adicional para o reprodutor de mídia. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">Classe que carrega um recurso do reprodutor de mídia e cria o objeto <span class="codeph"> MediaPlayerItem</span> correspondente. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe que contém os status compatíveis do reprodutor de mídia. </td> 
  </tr> 
  <tr rowsep="1"> 
