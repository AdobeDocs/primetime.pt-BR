---
description: Você pode usar a API do reprodutor Primetime para personalizar o comportamento do reprodutor. Essas classes descrevem o reprodutor de mídia e seus recursos.
...
Você pode usar a API do reprodutor Primetime para personalizar o comportamento do reprodutor. Essas classes descrevem o reprodutor de mídia e seus recursos.

Para ver a documentação completa da API do TVSDK, acesse o [Referências da API do Adobe Primetime](https://help.adobe.com/en_US/primetime/api/index.html).

Essas classes descrevem o reprodutor de mídia e seus recursos.
Pacote: [com.adobe.mediacore](https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/package-detail.html)
...
<table frame="all" colsep="1" rowsep="1" id="table_2801E01282A948E6917910CA2FD1E05C"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/ClosedCaptionStyles.html" format="html" scope="external"> EstilosDeLegendasOcultas</a></span> </td> 
   <td colname="2"> Classe que define todas as propriedades de estilo do texto em legendas ocultas. </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/ClosedCaptionsVisibility.html" format="html" scope="external"> VisibilidadeDasLegendasOcultas</a></span> </td> 
   <td colname="2"> Classe que controla se as legendas ocultas estão visíveis. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe de base de fábrica para criar e gerenciar vários componentes usados no fluxo de trabalho de publicidade. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">Implementação padrão de <span class="codeph"> MediaPlayerClient</span> fábrica que fornece suporte para metadados e processo de resolução de anúncios. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe de configuração para implementação padrão do reprodutor de mídia. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe de configuração do item de reprodutor de mídia padrão. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Carregador de item do reprodutor de mídia padrão. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe de configuração do reprodutor de mídia. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe que fornece contexto adicional ao reprodutor de mídia. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">Classe que carrega um recurso de reprodutor de mídia e cria a classe correspondente <span class="codeph"> MediaPlayerItem</span> objeto. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe que contém os status suportados do reprodutor de mídia. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2">Classe da exibição que será usada pelo <span class="codeph"> MediaPlayer</span> para renderização de vídeo. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe que contém os tipos de recursos de mídia suportados. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/TextFormat.html" format="html" scope="external"> FormatoDeTexto</a></span> </td> 
  ...
  <tr rowsep="0"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/Version.html" format="html" scope="external"> Versão</a></span> </td> 
