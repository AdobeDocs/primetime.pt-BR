---
description: Você pode usar a API do Primetime Player para personalizar o comportamento do player. Essas classes descrevem seu media player e seus recursos.
seo-description: Você pode usar a API do Primetime Player para personalizar o comportamento do player. Essas classes descrevem seu media player e seus recursos.
...
Você pode usar a API do Primetime Player para personalizar o comportamento do player. Essas classes descrevem seu media player e seus recursos.

Para ver a documentação completa da API para TVSDK, acesse as referências [da API do](https://help.adobe.com/en_US/primetime/api/index.html)Adobe Primetime.
...
<table frame="all" colsep="1" rowsep="1" id="table_2801E01282A948E6917910CA2FD1E05C"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/ClosedCaptionStyles.html" format="html" scope="external"> EstilosLegendasFechadas</a></span> </td> 
   <td colname="2"> Classe que define todas as propriedades de estilo para o texto em legendas fechadas. </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/ClosedCaptionsVisibility.html" format="html" scope="external"> VisibilidadeDeLegendasFechadas</a></span> </td> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe básica de fábrica para criar e gerenciar vários componentes usados no fluxo de trabalho de publicidade. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">Implementação padrão da fábrica <span class="codeph"> MediaPlayerClient</span> que fornece suporte para o processo de resolução de metadados e anúncios. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe de configuração para a implementação padrão do player de mídia. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe de configuração de item de media player padrão. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Carregador de itens padrão do media player. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe de configuração do Media Player. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe que fornece contexto adicional ao player de mídia. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">Classe que carrega um recurso de player de mídia e cria o objeto <span class="codeph"> MediaPlayerItem</span> correspondente. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe que contém os status suportados do player de mídia. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2">Classe para a exibição que será usada pelo <span class="codeph"> MediaPlayer</span> para renderização de vídeo. </td> 
  </tr> 
  <tr rowsep="1"> 
