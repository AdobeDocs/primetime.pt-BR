...
# NATIVE_ERROR: valores de reprodução de vídeo{#native-error-video-playback-values}
...
<table> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Valor para a chave de metadados RUNTIME_CODE </th> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> O leitor de mídia não pode ler mais porque atingiu o tempo definido por <span class="codeph"> setHoldAt</span> API. </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> O leitor de mídia não pode carregar segmentos porque atingiu o fim da janela ativa. O carregamento do segmento será retomado quando o servidor adicionar nova mídia à janela ativa. Normalmente, esse estado é atingido se: 
    <ul id="ul_FCFF658EDA4144E59970B317D6DEB624"> 
     ...
     <li id="li_1B14716B2157492AB1859306D1250523">O próximo período é um período ativo com uma substituição de mídia pendente (devido a <span class="codeph"> InserirPor</span> API) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> A reprodução HLS não foi habilitada no Flash Player. Consulte <span class="codeph"> AuthorizedFeatures.enableHLSPlayback</span>. </td> 
  </tr> 
  <tr> 
