...
<table id="table_466538B1C2A646B89EB4F9AA111203BE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3">Para obter mais informações, consulte <a href="../../tvsdk-1.4-for-android/ui-configure/android-1.4-ui-seek-scrub-bar-display.md">Exibir uma barra de depuração de busca com a posição</a>de reprodução atual. </td> 
  </tr> 
 </tbody> 
</table>
