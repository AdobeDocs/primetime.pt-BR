---
description: O TVSDK exige requisitos específicos para conteúdo de mídia, conteúdo de manifesto, DRM e versões de software.
title: Requisitos
...
O TVSDK exige requisitos específicos para conteúdo de mídia, conteúdo de manifesto, DRM e versões de software.
...
A versão de `#EXT-X-VERSION` no arquivo [!DNL .m3u8] afeta quais recursos estão disponíveis para o seu aplicativo e quais marcas de `EXT` são válidas na sua lista de reprodução/manifesto.
