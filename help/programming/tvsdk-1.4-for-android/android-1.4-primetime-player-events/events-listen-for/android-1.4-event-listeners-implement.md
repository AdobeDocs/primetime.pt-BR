...
Para ser notificado sobre todos os eventos relacionados ao DRM, aguarde `onDRMMetadata(DRMMetadataInfo drmMetadataInfo)`. O TVSDK despacha eventos DRM adicionais por meio da classe `DRMManager`.
