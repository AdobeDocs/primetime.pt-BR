...
Para ser notificado sobre todos os eventos relacionados a QoS, registre uma implementação da `MediaPlayer.QOSEventListener` inclusão dos seguintes retornos de chamada:
...
| [onOperationFailed](https://help.adobe.com/en_US/primetime/api/psdk/javadoc_1.4/com/adobe/mediacore/MediaPlayer.QOSEventListener.html)(MediaPlayerNotification). [Aviso](https://help.adobe.com/en_US/primetime/api/psdk/javadoc_1.4/com/adobe/mediacore/MediaPlayerNotification.Warning.html) ) | Ocorreu um erro recuperável. |
