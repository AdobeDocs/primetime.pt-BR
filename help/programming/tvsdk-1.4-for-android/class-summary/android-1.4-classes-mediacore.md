...
Para ver a documentação completa da API para TVSDK, acesse [Referências da API do Adobe Primetime](https://help.adobe.com/en_US/primetime/api/index.html#api-Adobe_Primetime_API_References).
...
<table frame="all" colsep="1" rowsep="1" id="table_2801E01282A948E6917910CA2FD1E05C"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">Interface pública para a classe <span class="codeph"> DefaultMediaPlayer</span>. Inclui listas discriminadas para Evento, PlayerState e Visibilidade. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe para a visualização que será usada pelo MediaPlayer para renderização de vídeo. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe que envolve todas as informações sobre um recurso de mídia. Inclui lista discriminada para Tipo de recurso de mídia. </td> 
  </tr> 
  <tr rowsep="1"> 
