...
<table frame="all" colsep="1" rowsep="1" id="table_DBA8CACF02DB4AF2B053E560850B49CE"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2">O tipo de notificação. Dependendo da plataforma, essa propriedade se refere a um tipo enumerado com possíveis valores de <span class="codeph"> INFO</span>, <span class="codeph"> AVISO</span> ou <span class="codeph"> ERRO</span>. Este é o agrupamento de nível superior para notificações. </td> 
  </tr> 
  <tr rowsep="1"> 
