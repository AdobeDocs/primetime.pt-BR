...
<table id="table_466538B1C2A646B89EB4F9AA111203BE"> 
 <thead> 
  <tr> 
   ...
   <th colname="col2" class="entry"> Política de comportamento padrão do TVSDK do navegador </th> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3">Para obter mais informações, consulte <a href="../../browser-tvsdk-2.4/content-playback-options-browser-tvsdk/ui-configure/t-psdk-browser-tvsdk-2.4-ui-seek-scrub-bar-display.md" format="dita" scope="local"> Lidar com busca ao usar a barra de busca</a> </td> 
  </tr> 
 </tbody> 
</table>
...
Você pode definir seu comportamento preferencial na fábrica de conteúdo de anúncios no método `retrieveAdPolicySelectorCallbackFunc` . Você pode usar os métodos `selectPolicyForAdBreak`, `selectWatchedPolicyForAdBreak`, `selectPolicyForSeekIntoAd` e `selectAdBreaksToPlay` no fatory de conteúdo para selecionar uma política.
