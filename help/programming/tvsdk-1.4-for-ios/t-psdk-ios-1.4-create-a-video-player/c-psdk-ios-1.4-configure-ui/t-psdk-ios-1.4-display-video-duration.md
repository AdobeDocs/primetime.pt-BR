...
Para obter mais informações sobre a API, consulte [TVSDK 1.4 para referência da API do iOS](https://help.adobe.com/en_US/primetime/api/psdk/appledoc/index.html)
