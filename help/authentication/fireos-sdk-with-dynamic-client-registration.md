...
- O parâmetro redirectUrl para FireTV é definido pelo SDK para autenticação adobepass://android.app as é manipulada por uma instância exclusiva do AccessEnabler.
